 ...
 * @info: the is the parameter & return info struct
 * @av: the arg vector from main()
 *
 * Return: return 0 on success, otherwise return 1 on error, or error code
 */
...
/**
 * find_cmd - this locates a command in PATH
 * @info: this is the parameter & return info struct
 *
 * Return: return void
 */
