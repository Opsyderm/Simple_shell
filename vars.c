...
/**
 * is_chain - tests if present char in buffer is a chain delimeter
 * @info: this is the parameter struct
 * @buf: the character buffer
 * @p: this is the address of present position in buf
 *
...
/**
 * check_chain - the checks we should continue chaining based on former status
 * @info: this is the parameter struct
 * @buf: the character buffer
 * @p: address of present position in buffer
