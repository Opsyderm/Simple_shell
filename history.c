...
/**
 * get_history_file - this will get history file
...
/**
 * write_history - makes a file, or appends to a present file
 * @info: this is the parameter struct
 *
...
/**
 * renumber_history - this will renumbers the history linked list after changes
