...
/**
 * struct passinfo - this contains pseudo-arguements to pass in a function,
 * allowing uniform prototype for function pointer struct
 * @path: a string path for the current command
 * @argc: this is the argument count
 * @line_count: this is the error count
 * @arg: this is a string generated from getline containing the arguements
 * @argv:t his is an array of strings generated from arguement
 ...
 * @fname: this is the filename of program
...
typedef struct passinfo
{
	...
	char **cmd_buf; /* pointer to the cmd ; chain buffer, for the memory mangement */
